...
\textbf{R24 alignment note:} BA1 identity semantics remain retained. Statements below that describe BA2 as \texttt{NOT STARTED / NEXT AUTHORIZED PHASE} are closure-time sequencing, not current execution state. Current R24 forward state is recorded in \texttt{DDTA\_R24\_DECISION\_RULE\_CHECKPOINT.md}; the active BA2 working revision is \texttt{BA2\_RELATION\_ACTION\_VOCABULARY\_R2.md}.
