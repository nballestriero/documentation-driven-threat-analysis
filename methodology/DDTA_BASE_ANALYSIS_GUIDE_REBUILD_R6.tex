...
%<PAGE-HASH-DEFS>
\expandafter\def\csname PageMDfive1\endcsname{e63af1cc667f4b7c715205d4e06762a3}
...
\expandafter\def\csname PageMDfive29\endcsname{bbee85ba9de0e66ed44643aa1a1aa67f}
\expandafter\def\csname PageMDfive30\endcsname{8591805381a0a7625717bdfe5202dbbb}
%</PAGE-HASH-DEFS>
...
\textbf{Repository baseline} & \texttt{5f18cd8bfcf8175a22e08a02ce3763b83eb95e08} \\
...
\begin{enumerate}
  ...
  \item continuare la BA DermaTriage dalla documentazione corrente senza copiare la cardinalita' dell'albero documentale;
  \item prendere dal patrimonio BA precedente il prossimo operatore effettivamente necessario nel flusso di analisi;
  \item descriverlo con il CDC, applicarlo al caso, aggiungere esempi/boundary e modificarlo soltanto se il caso espone una pressione reale;
  \item procedere agli operatori successivi uno alla volta, aggiornando sempre la guida cumulativa e regression-checkando quelli gia' trattati;
...
La grammatica generale include ora anche l'indipendenza tra cardinalita' documentale e BA e il feedback strutturale verso la documentazione. Nessun operatore del catalogo BA e' ancora stato inserito nella parte cumulativa della nuova guida. Il prossimo gate e' la ripresa dell'analisi DermaTriage e la review, con \texttt{CDC-R1}, del primo operatore effettivamente usato.
\end{ddtaopen}
%</PAGE-CONTENT:29>
