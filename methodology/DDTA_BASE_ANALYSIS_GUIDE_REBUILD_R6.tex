...
\hypersetup{
  pdftitle={DDTA Base Analysis Guide - Rebuild R6},
...
%<PAGE-HASH-DEFS>
\expandafter\def\csname PageMDfive1\endcsname{ae7b6caa51d6adf9e61b021350da02ed}
...
\expandafter\def\csname PageMDfive22\endcsname{230ef1c2f1fa7c46ae233ee130c00449}
\expandafter\def\csname PageMDfive23\endcsname{3915eaee02f714ac47e0dfa764b2836f}
\expandafter\def\csname PageMDfive24\endcsname{5475a02c3223c3fac62a7eebe62f6be2}
\expandafter\def\csname PageMDfive25\endcsname{e1b1becfc138e20474529fae47de6a05}
\expandafter\def\csname PageMDfive26\endcsname{435e9ecddb23d230df9cc32766e10610}
\expandafter\def\csname PageMDfive27\endcsname{9d02d27cc2ad8bb4e1b30d441667e854}
\expandafter\def\csname PageMDfive28\endcsname{90b6659e5a0105e0cd7268d3f76137f6}
\expandafter\def\csname PageMDfive29\endcsname{9d695761081a38d07b9fa704d9a4020e}
\expandafter\def\csname PageMDfive30\endcsname{f1638875df434f4265584c30552e5b11}
%</PAGE-HASH-DEFS>
...
\fancyhead[R]{\sffamily\small\color{DDTABlue}Rebuild R6 - CANDIDATE}
\fancyfoot[L]{\sffamily\scriptsize\color{DDTAGray}Cumulative rebuild - human-readable method, controlled semantics}
%<PAGE-DESC:1>Frontespizio della Base Analysis Guide Rebuild R6
%<PAGE-CONTENT:1>
\begin{titlepage}
\thispagestyle{empty}
\vspace*{12mm}
...
\vspace{2mm}
{\sffamily\color{DDTABlue}\fontsize{18}{22}\selectfont Rebuild R6 - Candidate cumulative reconstruction}\par
...
{\scriptsize
\textbf{Attivi:} \nolinkurl{DDTA_DOCUMENTATION_AUTHORING_GUIDE_R7_REBUILD_R8.tex}; \nolinkurl{DDTA_BASE_ANALYSIS_GUIDE_REBUILD_R6.tex}; \nolinkurl{DDTA_DERMATRIAGE_PARALLEL_CASE_STUDY_R15_PRIORITY_CONSOLIDATION_R1.tex}.\par
\textbf{Piano corrente:} \nolinkurl{DDTA_R25_BASE_ANALYSIS_GUIDE_REBUILD_WORK_PLAN_R4.md}; working analysis: \nolinkurl{DDTA_R25_DERMATRIAGE_CASE_STUDY_WORKING_ANALYSIS_R1.md}.\par
\textbf{Riferimenti:} Documentation Guide R6 Candidate R2; Operational Guide R3 + BA0--BA5; BA rebuild source register; Core/Complete BA Candidate R1.\par
\textbf{Fase corrente:} usare la BA precedente per completare l'analisi della documentazione DermaTriage riscritta fino alla chiusura bounded di \texttt{MR-01}; solo dopo consolidare nella nuova guida i primi costrutti che abbiano gia' ricevuto sufficiente applicazione e review.
}
\end{ddtaopen}
...
\textbf{Repository baseline} & \texttt{9a9ae720ceca6396faede419dca6a879d5aba842} \\
\textbf{Predecessore cumulativo} & \nolinkurl{DDTA_BASE_ANALYSIS_GUIDE_REBUILD_R5} \\
\textbf{Authority BA corrente} & R3 Operational Guide + BA0 R1 / BA1 R1 / BA2 R3 / BA3 R1 / BA4 R1 / BA5 R1 \\
\textbf{Scopo di R6} & Integrare nella guida cumulativa le regole emerse dalla review strutturale DermaTriage: indipendenza tra cardinalita' documentale e BA, feedback BA verso la documentazione senza inversione di authority e test di utilita' downstream. Nessun operatore BA viene ancora aggiunto al catalogo della nuova guida. \\
...
Questa R6 integra il feedback strutturale nella grammatica generale della BA. Non introduce ancora nessun operatore del catalogo precedente. Gli operatori verranno riesaminati e inseriti uno alla volta mentre vengono applicati alla documentazione DermaTriage corrente, secondo il Construct Description Contract.
\end{ddtaopen}
%</PAGE-CONTENT:22>

\clearpage
%<PAGE-DESC:23>Appendice temporanea - scopo, lineage e confine del rebuild
%<PAGE-CONTENT:23>
...
\clearpage
%<PAGE-DESC:24>Appendice temporanea - corpus e stati epistemici
%<PAGE-CONTENT:24>
...
\clearpage
%<PAGE-DESC:25>Appendice temporanea - Construct Description Contract e principio espositivo
%<PAGE-CONTENT:25>
...
\clearpage
%<PAGE-DESC:26>Appendice temporanea - CDC direzione della spiegazione e revisione
%<PAGE-CONTENT:26>
...
\clearpage
%<PAGE-DESC:27>Appendice temporanea - CDC campi 1-10
%<PAGE-CONTENT:27>
...
\clearpage
%<PAGE-DESC:28>Appendice temporanea - CDC campi 11-20
%<PAGE-CONTENT:28>
...
\clearpage
%<PAGE-DESC:29>Appendice temporanea - roadmap corrente del rebuild
%<PAGE-CONTENT:29>
...
\begin{enumerate}
  ...
  \item assumere le Sezioni 1--6 come base espositiva corrente della Rebuild R6;
  ...
  \item completare la Base Analysis di \texttt{MR-01} sulla documentazione DermaTriage riscritta, seguendo l'ordine documentale e senza copiare la cardinalita' dell'albero;
  \item usare gli elementi e gli operatori della BA precedente come baseline operativa durante questo passaggio, mantenendo candidate, ambiguita', gap e pressure espliciti nel case study e nel working analysis;
  \item non trasferire automaticamente un operatore nella nuova guida al primo utilizzo: accumulare prima un minimo sufficiente di applicazione all'interno di \texttt{MR-01};
  \item raggiunto il checkpoint bounded di \texttt{MR-01}, riesaminare con \texttt{CDC-R1} i costrutti effettivamente usati e consolidare nella guida cumulativa soltanto quelli sufficientemente stabili, con esempi, boundary, signature e cardinalita' supportati;
  \item se la BA espone un problema della documentazione, riaprire il layer documentale competente e poi revalidare la BA; non colmare il gap leggendo direttamente le fonti originali nel layer BA;
  \item solo dopo BA accettata per uno scope, produrre e verificare le prime view Mermaid;
  \item dopo il ciclo retrospettivo, continuare documentazione e BA in parallelo secondo i rispettivi boundary di authority.
\end{enumerate}

\begin{ddtaopen}[title={Stop point di questa R6}]
La grammatica generale include ora anche l'indipendenza tra cardinalita' documentale e BA e il feedback strutturale verso la documentazione. Nessun operatore del catalogo BA e' ancora stato inserito nella parte cumulativa della nuova guida. Il prossimo gate non e' l'ammissione immediata di un singolo operatore: e' il completamento bounded della BA di \texttt{MR-01} usando la BA precedente come riferimento operativo. Solo dopo questo passaggio verranno consolidati nella revisione successiva i primi costrutti supportati da sufficiente evidence applicativa.
\end{ddtaopen}
%</PAGE-CONTENT:29>

\clearpage
%<PAGE-DESC:30>Indice di integrita' delle pagine
%<PAGE-CONTENT:30>
...
\midrule
%<PAGE-INTEGRITY-ROWS>
\IntegrityRow{1}{Frontespizio della Base Analysis Guide Rebuild R6}{\PageMDfive{1}}
...
\IntegrityRow{23}{Appendice temporanea - scopo, lineage e confine del rebuild}{\PageMDfive{23}}
\IntegrityRow{24}{Appendice temporanea - corpus e stati epistemici}{\PageMDfive{24}}
\IntegrityRow{25}{Appendice temporanea - Construct Description Contract e principio espositivo}{\PageMDfive{25}}
\IntegrityRow{26}{Appendice temporanea - CDC direzione della spiegazione e revisione}{\PageMDfive{26}}
\IntegrityRow{27}{Appendice temporanea - CDC campi 1-10}{\PageMDfive{27}}
\IntegrityRow{28}{Appendice temporanea - CDC campi 11-20}{\PageMDfive{28}}
\IntegrityRow{29}{Appendice temporanea - roadmap corrente del rebuild}{\PageMDfive{29}}
\IntegrityRow{30}{Indice di integrita' delle pagine}{\PageMDfive{30}}
%</PAGE-INTEGRITY-ROWS>
\bottomrule
\end{longtable}
\endgroup
...
Questa pagina chiude la Rebuild R6 di review. Le pagine di appendice temporanea restano deliberatamente presenti finche' il rebuild non avra' trasferito nella guida definitiva tutte le regole metodologiche che devono sopravvivere.
\end{ddtaopen}
%</PAGE-CONTENT:30>
