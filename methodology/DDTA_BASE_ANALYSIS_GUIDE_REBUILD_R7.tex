...
\hypersetup{
  pdftitle={DDTA Base Analysis Guide - Rebuild R7 - constrain integration R2},
...
%<PAGE-HASH-DEFS>
\expandafter\def\csname PageMDfive1\endcsname{793f8f64517e213d84b1975c0ee0f67f}
...
\expandafter\def\csname PageMDfive59\endcsname{3915eaee02f714ac47e0dfa764b2836f}
\expandafter\def\csname PageMDfive60\endcsname{5475a02c3223c3fac62a7eebe62f6be2}
\expandafter\def\csname PageMDfive61\endcsname{e1b1becfc138e20474529fae47de6a05}
\expandafter\def\csname PageMDfive62\endcsname{435e9ecddb23d230df9cc32766e10610}
\expandafter\def\csname PageMDfive63\endcsname{9d02d27cc2ad8bb4e1b30d441667e854}
\expandafter\def\csname PageMDfive64\endcsname{90b6659e5a0105e0cd7268d3f76137f6}
\expandafter\def\csname PageMDfive65\endcsname{055d9c5848fbdcce60b592d60a2d0c14}
\expandafter\def\csname PageMDfive66\endcsname{aaac2dbdd840f8d2ca65aa887c40c15e}
\expandafter\def\csname PageMDfive67\endcsname{13cdd31df41e1d75e405e6ba020261fa}
%</PAGE-HASH-DEFS>
...
\textbf{Fase corrente:} ricostruire un operatore alla volta mantenendo R7 cumulativa. \texttt{transfer}, \texttt{produce} e \texttt{realize} restano completi; questo incremento ricostruisce \texttt{constrain} usando DermaTriage R23 come evidence applicativa corrente. Le sezioni di discriminazione verso operatori vicini restano intenzionalmente placeholder finche' il catalogo non sara' sufficientemente stabile.
}
\end{ddtaopen}
...
\textbf{Repository baseline} & \texttt{d3db904d3186fc1234d19f2608e71eaa6c2021c4} \\
...
\textbf{Scopo di R7} & Ricostruzione cumulativa degli operatori BA. \texttt{transfer}, \texttt{produce} e \texttt{realize} restano completi; questo incremento aggiunge \texttt{constrain} con significato, firma unica, forme ammesse di \texttt{constraintValue}, identity rules, domande di identificazione, esempi, prompt LLM, output BA atteso e projection grafica. Gli altri operatori non vengono ancora consolidati. \\
...
\clearpage
%<PAGE-DESC:59>Appendice temporanea - scopo, lineage e confine del rebuild
%<PAGE-CONTENT:59>
...
%<PAGE-DESC:60>Appendice temporanea - corpus e stati epistemici
%<PAGE-CONTENT:60>
...
%<PAGE-DESC:61>Appendice temporanea - Construct Description Contract e principio espositivo
%<PAGE-CONTENT:61>
...
%<PAGE-DESC:62>Appendice temporanea - CDC direzione della spiegazione e revisione
%<PAGE-CONTENT:62>
...
%<PAGE-DESC:63>Appendice temporanea - CDC campi 1-10
%<PAGE-CONTENT:63>
...
%<PAGE-DESC:64>Appendice temporanea - CDC campi 11-20
%<PAGE-CONTENT:64>
...
%<PAGE-DESC:65>Appendice temporanea - roadmap corrente del rebuild R7
%<PAGE-CONTENT:65>
...
\begin{enumerate}
  ...
  \item assumere le Sezioni 1--10 come base espositiva corrente della Rebuild R7;
  ...
  \item considerare \texttt{transfer}, \texttt{produce}, \texttt{realize} e \texttt{constrain} i primi quattro operatori completamente ricostruiti nella nuova struttura: definizione generale, firma, roleKey, cardinalita', identity rules, question pack, esempi, prompt LLM, output BA atteso e projection grafica;
  ...
  \item continuare la Base Analysis di \texttt{MR-01} dalla documentazione DermaTriage corrente consolidata in R23, usando l'authority BA corrente come riferimento operativo e senza anticipare costrutti non ancora riesaminati;
  \item per il prossimo operatore effettivamente necessario, partire dalle pagine e dagli esempi delle guide precedenti, ricostruire prima il metodo generale e poi verificarlo con evidence corrente DermaTriage;
...
La Rebuild R7 contiene ora la ricostruzione completa di \texttt{transfer}, \texttt{produce}, \texttt{realize} e \texttt{constrain}. Gli altri operatori restano disponibili attraverso l'authority BA corrente e la genealogia precedente ma non sono ancora stati riscritti nella nuova guida. \texttt{constrain} viene consolidato con una firma top-level unica e con forme di \texttt{constraintValue} che preservano sia i contract nominati sia le restriction locali; la projection mantiene inoltre distinto il data contract dal transport contract. Il prossimo operatore verra' ricostruito soltanto quando il flusso DermaTriage lo richiedera' e fornira' evidence sufficiente.
\end{ddtaopen}
%</PAGE-CONTENT:65>

\clearpage

%<PAGE-DESC:66>Indice di integrita' delle pagine
%<PAGE-CONTENT:66>
...
\IntegrityRow{59}{Appendice temporanea - scopo, lineage e confine del rebuild}{\PageMDfive{59}}
\IntegrityRow{60}{Appendice temporanea - corpus e stati epistemici}{\PageMDfive{60}}
\IntegrityRow{61}{Appendice temporanea - Construct Description Contract e principio espositivo}{\PageMDfive{61}}
\IntegrityRow{62}{Appendice temporanea - CDC direzione della spiegazione e revisione}{\PageMDfive{62}}
\IntegrityRow{63}{Appendice temporanea - CDC campi 1-10}{\PageMDfive{63}}
\IntegrityRow{64}{Appendice temporanea - CDC campi 11-20}{\PageMDfive{64}}
\IntegrityRow{65}{Appendice temporanea - roadmap corrente del rebuild R7}{\PageMDfive{65}}
\IntegrityRow{66}{Indice di integrita' delle pagine}{\PageMDfive{66}}
\IntegrityRow{67}{Appendice temporanea - laboratorio prove grafiche Mermaid da cancellare}{\PageMDfive{67}}
%</PAGE-INTEGRITY-ROWS>
\bottomrule
\end{longtable}
\endgroup
...
%<PAGE-DESC:67>Appendice temporanea - laboratorio prove grafiche Mermaid da cancellare
%<PAGE-CONTENT:67>
