...
%<PAGE-HASH-DEFS>
\expandafter\def\csname PageMDfive1\endcsname{0632ba4ee70293386c08c6be0dd10d89}
...
\expandafter\def\csname PageMDfive84\endcsname{745556371bea3ab46039e71ad01143b7}
...
\textbf{Fase corrente:} mantenere R7 cumulativa e ricostruire soltanto i costrutti richiesti dalla BA corrente. \texttt{transfer}, \texttt{produce}, \texttt{realize}, \texttt{constrain} e lo scoped modifier \texttt{condition} restano ricostruiti; questo incremento raffina la candidate \texttt{operatorStructure.decisionRule} dopo il pressure test DermaTriage, normalizzando i comparison key in forma sintetica \texttt{eq}/\texttt{ne} e aggiungendo \texttt{gt} come candidate minima, con preservazione esplicita dei branch residuali.
}
\end{ddtaopen}
