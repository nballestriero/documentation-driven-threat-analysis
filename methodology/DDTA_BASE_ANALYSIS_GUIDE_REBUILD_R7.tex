...
%<PAGE-HASH-DEFS>
\expandafter\def\csname PageMDfive1\endcsname{10bc17600c101ae74d88dc7435e592ab}
...
\expandafter\def\csname PageMDfive22\endcsname{ec370772257111db29fb581af0e74919}
...
\expandafter\def\csname PageMDfive50\endcsname{3915eaee02f714ac47e0dfa764b2836f}
\expandafter\def\csname PageMDfive51\endcsname{5475a02c3223c3fac62a7eebe62f6be2}
\expandafter\def\csname PageMDfive52\endcsname{e1b1becfc138e20474529fae47de6a05}
\expandafter\def\csname PageMDfive53\endcsname{435e9ecddb23d230df9cc32766e10610}
\expandafter\def\csname PageMDfive54\endcsname{9d02d27cc2ad8bb4e1b30d441667e854}
\expandafter\def\csname PageMDfive55\endcsname{90b6659e5a0105e0cd7268d3f76137f6}
\expandafter\def\csname PageMDfive56\endcsname{e12ab1cb46da8ef78855f0d4ce6ca339}
\expandafter\def\csname PageMDfive57\endcsname{0a71790aa6697b4c7c276d187e5d1d0d}
\expandafter\def\csname PageMDfive58\endcsname{13cdd31df41e1d75e405e6ba020261fa}
%</PAGE-HASH-DEFS>
...
\textbf{Fase corrente:} ricostruire un operatore alla volta mantenendo R7 cumulativa. \texttt{transfer} e \texttt{produce} restano completi; questo incremento ricostruisce \texttt{realize}. Le sezioni di discriminazione verso operatori vicini restano intenzionalmente placeholder finche' il catalogo non sara' sufficientemente stabile. DermaTriage R20 viene usato solo come esempio corrente e regression evidence.
}
\end{ddtaopen}
...
\textbf{Repository baseline} & \texttt{50ce7fd09a5da8ad5cba9e810724dc562d092b71} \\
...
La R6 si fermava prima del catalogo operativo. La R7 mantiene ora il catalogo in forma cumulativa: \texttt{transfer} e \texttt{produce} restano completamente ricostruiti e questo incremento aggiunge \texttt{realize}, sempre a partire dalla semantica gia' ammessa dall'authority BA corrente e dalle guide precedenti. Gli esempi di progetto verificano e chiariscono i costrutti, ma non ne determinano la definizione. L'ingresso di un operatore nella guida rebuild non equivale a promotion normativa della rebuild.
\end{ddtaopen}
%</PAGE-CONTENT:22>
...
%<PAGE-DESC:50>Appendice temporanea - scopo, lineage e confine del rebuild
%<PAGE-CONTENT:50>
...
%<PAGE-DESC:51>Appendice temporanea - corpus e stati epistemici
%<PAGE-CONTENT:51>
...
%<PAGE-DESC:52>Appendice temporanea - Construct Description Contract e principio espositivo
%<PAGE-CONTENT:52>
...
%<PAGE-DESC:53>Appendice temporanea - CDC direzione della spiegazione e revisione
%<PAGE-CONTENT:53>
...
%<PAGE-DESC:54>Appendice temporanea - CDC campi 1-10
%<PAGE-CONTENT:54>
...
%<PAGE-DESC:55>Appendice temporanea - CDC campi 11-20
%<PAGE-CONTENT:55>
...
%<PAGE-DESC:56>Appendice temporanea - roadmap corrente del rebuild R7
%<PAGE-CONTENT:56>
...
\begin{enumerate}
  ...
  \item considerare \texttt{transfer}, \texttt{produce} e \texttt{realize} i primi tre operatori completamente ricostruiti nella nuova struttura: definizione generale, firma, roleKey, cardinalita', identity rules, question pack, esempi, prompt LLM, output BA atteso e projection grafica;
  ...
  \item non considerare ancora \texttt{constrain} o altri operatori consolidati nella rebuild soltanto perche' compaiono negli esempi DermaTriage; riesaminare separatamente gli usi correnti di \texttt{realize} che mescolano capability astratte e tecnologie concrete;
...
La Rebuild R7 contiene ora la ricostruzione completa di \texttt{transfer}, \texttt{produce} e \texttt{realize}. Gli altri operatori restano quelli dell'authority BA corrente e non sono ancora stati riscritti nella nuova guida. La review di \texttt{realize} ha inoltre aperto un feedback separato sulla documentazione Stage 3: la guida non lo chiude inventando capability mancanti. Il prossimo passo puo' essere la ricostruzione completa del successivo operatore quando avremo evidence sufficiente, mantenendo DermaTriage come worked example e non come sorgente della semantica.
\end{ddtaopen}
%</PAGE-CONTENT:56>

\clearpage

%<PAGE-DESC:57>Indice di integrita' delle pagine
%<PAGE-CONTENT:57>
...
\IntegrityRow{50}{Appendice temporanea - scopo, lineage e confine del rebuild}{\PageMDfive{50}}
\IntegrityRow{51}{Appendice temporanea - corpus e stati epistemici}{\PageMDfive{51}}
\IntegrityRow{52}{Appendice temporanea - Construct Description Contract e principio espositivo}{\PageMDfive{52}}
\IntegrityRow{53}{Appendice temporanea - CDC direzione della spiegazione e revisione}{\PageMDfive{53}}
\IntegrityRow{54}{Appendice temporanea - CDC campi 1-10}{\PageMDfive{54}}
\IntegrityRow{55}{Appendice temporanea - CDC campi 11-20}{\PageMDfive{55}}
\IntegrityRow{56}{Appendice temporanea - roadmap corrente del rebuild R7}{\PageMDfive{56}}
\IntegrityRow{57}{Indice di integrita' delle pagine}{\PageMDfive{57}}
\IntegrityRow{58}{Appendice temporanea - laboratorio prove grafiche Mermaid da cancellare}{\PageMDfive{58}}
%</PAGE-INTEGRITY-ROWS>
\bottomrule
\end{longtable}
\endgroup
...
%<PAGE-DESC:58>Appendice temporanea - laboratorio prove grafiche Mermaid da cancellare
%<PAGE-CONTENT:58>
