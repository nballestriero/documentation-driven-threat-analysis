...
%<PAGE-HASH-DEFS>
\expandafter\def\csname PageMDfive1\endcsname{963b8105bb738cb9b71745fb55b2c322}
...
\expandafter\def\csname PageMDfive22\endcsname{d0e99aeacc13cf8937f831453e92c3ad}
...
\expandafter\def\csname PageMDfive32\endcsname{3915eaee02f714ac47e0dfa764b2836f}
\expandafter\def\csname PageMDfive33\endcsname{5475a02c3223c3fac62a7eebe62f6be2}
\expandafter\def\csname PageMDfive34\endcsname{e1b1becfc138e20474529fae47de6a05}
\expandafter\def\csname PageMDfive35\endcsname{435e9ecddb23d230df9cc32766e10610}
\expandafter\def\csname PageMDfive36\endcsname{9d02d27cc2ad8bb4e1b30d441667e854}
\expandafter\def\csname PageMDfive37\endcsname{90b6659e5a0105e0cd7268d3f76137f6}
\expandafter\def\csname PageMDfive38\endcsname{3e93d5a6ba1b5b059bc2bf0f09aa34a9}
\expandafter\def\csname PageMDfive39\endcsname{8b5136b47971b5ce22537a818bbf5bc0}
%</PAGE-HASH-DEFS>
...
\textbf{Fase corrente:} ricostruire un operatore alla volta. Questa revisione completa \texttt{transfer}; le sezioni di discriminazione verso operatori vicini restano intenzionalmente placeholder finche' il catalogo non sara' sufficientemente stabile. DermaTriage R20 viene usato solo come esempio corrente e regression evidence.
}
\end{ddtaopen}
...
\textbf{Repository baseline} & \texttt{b6a647e4eb17b7e931838499003ed4f26e082b7f} \\
...
\textbf{Scopo di R7} & Ricostruire in modo completo e generale l'operatore \texttt{transfer}: significato, criteri d'uso, firma, ruoli, cardinalita', identity rule, domande di identificazione, esempi, prompt LLM e output BA atteso. Gli altri operatori non vengono ancora consolidati. \\
...
La R6 si fermava prima del catalogo operativo. La R7 apre il catalogo ricostruendo \textbf{un solo operatore}, \texttt{transfer}, a partire dalla semantica gia' ammessa dall'authority BA corrente e dalle guide precedenti. Gli esempi di progetto verificano e chiariscono il costrutto, ma non ne determinano la definizione. Il fatto che \texttt{transfer} entri nella guida rebuild non equivale a promotion normativa della rebuild.
\end{ddtaopen}
%</PAGE-CONTENT:22>
...
%<PAGE-DESC:32>Appendice temporanea - scopo, lineage e confine del rebuild
%<PAGE-CONTENT:32>
...
%<PAGE-DESC:33>Appendice temporanea - corpus e stati epistemici
%<PAGE-CONTENT:33>
...
%<PAGE-DESC:34>Appendice temporanea - Construct Description Contract e principio espositivo
%<PAGE-CONTENT:34>
...
%<PAGE-DESC:35>Appendice temporanea - CDC direzione della spiegazione e revisione
%<PAGE-CONTENT:35>
...
%<PAGE-DESC:36>Appendice temporanea - CDC campi 1-10
%<PAGE-CONTENT:36>
...
%<PAGE-DESC:37>Appendice temporanea - CDC campi 11-20
%<PAGE-CONTENT:37>
...
%<PAGE-DESC:38>Appendice temporanea - roadmap corrente del rebuild R7
%<PAGE-CONTENT:38>
...
\begin{enumerate}
  ...
  \item assumere le Sezioni 1--7 come base espositiva corrente della Rebuild R7;
  ...
  \item considerare \texttt{transfer} il primo operatore completamente ricostruito nella nuova struttura: definizione generale, firma, roleKey, cardinalita', identity rules, question pack, esempi, prompt LLM e output BA atteso;
  ...
  \item non considerare ancora \texttt{produce}, \texttt{constrain} o altri operatori consolidati nella rebuild soltanto perche' compaiono negli esempi DermaTriage;
...
La Rebuild R7 consolida soltanto \texttt{transfer}. Gli altri operatori restano quelli dell'authority BA corrente e non sono ancora stati riscritti nella nuova guida. Il prossimo passo puo' essere la ricostruzione completa del successivo operatore quando avremo evidence sufficiente, mantenendo DermaTriage come worked example e non come sorgente della semantica.
\end{ddtaopen}
%</PAGE-CONTENT:38>

\clearpage

%<PAGE-DESC:39>Indice di integrita' delle pagine
%<PAGE-CONTENT:39>
...
\IntegrityRow{32}{Appendice temporanea - scopo, lineage e confine del rebuild}{\PageMDfive{32}}
\IntegrityRow{33}{Appendice temporanea - corpus e stati epistemici}{\PageMDfive{33}}
\IntegrityRow{34}{Appendice temporanea - Construct Description Contract e principio espositivo}{\PageMDfive{34}}
\IntegrityRow{35}{Appendice temporanea - CDC direzione della spiegazione e revisione}{\PageMDfive{35}}
\IntegrityRow{36}{Appendice temporanea - CDC campi 1-10}{\PageMDfive{36}}
\IntegrityRow{37}{Appendice temporanea - CDC campi 11-20}{\PageMDfive{37}}
\IntegrityRow{38}{Appendice temporanea - roadmap corrente del rebuild R7}{\PageMDfive{38}}
\IntegrityRow{39}{Indice di integrita' delle pagine}{\PageMDfive{39}}
%</PAGE-INTEGRITY-ROWS>
\bottomrule
\end{longtable}
\endgroup
...
Questa pagina chiude la Rebuild R7 di review. Le pagine di appendice temporanea restano deliberatamente presenti finche' il rebuild non avra' trasferito nella guida definitiva tutte le regole metodologiche che devono sopravvivere.
\end{ddtaopen}
%</PAGE-CONTENT:39>
