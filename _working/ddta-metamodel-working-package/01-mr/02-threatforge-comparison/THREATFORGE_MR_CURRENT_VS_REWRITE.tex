...
\begin{quote}
Non-canonical case study. Baseline for current documents:
...
\subsubsection{What moved down}\label{what-moved-down-3}
...
\subsubsection{What moved down}\label{what-moved-down-4}
