...
\subsection{MR-0001 - Accesso controllato all'area
...
indipendentemente dalla metodologia di analisi che potra essere
applicata.
...
capability with its own stakeholders, objectives and Decisions (for
...
\item
  ...
  than described through temporary statements such as ``not yet
  decided''.
\item
