...
\hypersetup{
  pdftitle={DDTA DermaTriage - Parallel Case Study R23 - FR03 Documentation/BA Separation},
...
%<PAGE-HASH-DEFS>
\expandafter\def\csname PageMDfive1\endcsname{9bea51a98ff234e0f8fdaf06b23672b6}
...
\expandafter\def\csname PageMDfive9\endcsname{49fe14ea29aceb5b54c2982bab1cb1a8}
\expandafter\def\csname PageMDfive10\endcsname{a9569e8086367d55854bccd3cf09f99f}
...
\expandafter\def\csname PageMDfive16\endcsname{2eac957d3478e9a8a2e9ed841ce61f98}
\expandafter\def\csname PageMDfive17\endcsname{37ec0fabe4bb5acf754cb6e635573f03}
\expandafter\def\csname PageMDfive18\endcsname{9a6c730e4106db99ff1a1027de8b7c97}
%</PAGE-HASH-DEFS>
...
{\scriptsize
\textbf{Attivi:} \nolinkurl{DDTA_DOCUMENTATION_AUTHORING_GUIDE_R7_REBUILD_R8.tex}; \nolinkurl{DDTA_BASE_ANALYSIS_GUIDE_REBUILD_R6.tex}; questo \nolinkurl{DDTA_DERMATRIAGE_PARALLEL_CASE_STUDY_R23_FR03_DOCUMENTATION_BA_SEPARATION_R1.tex}. Working plan: \nolinkurl{DDTA_R25_BASE_ANALYSIS_GUIDE_REBUILD_WORK_PLAN_R5.md}.\par
\textbf{Riferimenti BA:} \nolinkurl{DDTA_BASE_ANALYSIS_OPERATIONAL_GUIDE_R3.tex} + BA0--BA5, source register e Core/Complete BA Candidate R1. \textbf{Fase corrente:} \texttt{FR-MR01-03-03} mantiene separati testo documentale ed estrazione BA; i precedenti \texttt{realize} aggregati non sono riportati. La review prosegue dopo R23. I gap di significato tornano prima alla documentazione.\par
...
\textbf{Functional obligation}\par
Lo Stage 3 recupera casi dermatologici storici simili al caso corrente usando come query la descrizione clinica prodotta dallo Stage 2 e rende i casi recuperati disponibili allo Stage 4 per la sintesi multi-source.

Le descrizioni dei casi dermatologici storici, nel campo \texttt{image\_description}, sono rappresentate mediante embedding prodotti con \texttt{sentence-transformers/all-MiniLM-L6-v2} e indicizzate in \texttt{ChromaDB}, che svolge il ruolo di archivio vettoriale. Per il caso corrente, la descrizione clinica prodotta dallo Stage 2 viene rappresentata mediante lo stesso modello di embedding e usata per interrogare l'archivio vettoriale. Il confronto usa cosine similarity e recupera i cinque casi con maggiore similarita'. Per ciascun caso recuperato il risultato espone \texttt{patient\_id}, \texttt{diagnosis}, \texttt{urgency\_level} e \texttt{similarity\_score}.

\textbf{Functional clauses / inherited \texttt{normativeClause [1..*]}}\par
\begin{enumerate}
  \item Lo Stage 3 MUST recuperare casi dermatologici storici simili usando come query la descrizione clinica prodotta dallo Stage 2.
...
\BACandidate{ClinicalDescriptionEmbeddingGeneration} \BANew{}; \BACandidate{ClinicalDescriptionEmbedding} \BANew{}; \BACandidate{HistoricalCaseDescription} \BANew{}; \BACandidate{HistoricalCaseEmbeddingGeneration} \BANew{}; \BACandidate{HistoricalCaseEmbedding} \BANew{}; \BACandidate{HistoricalCaseVectorIndexing} \BANew{}; \BACandidate{HistoricalCaseVectorIndex} \BANew{}; \BACandidate{HistoricalCaseSimilarityRetrieval} \BANew{}; \BACandidate{RetrievedHistoricalCases} \BANew{}.
\end{ddtareferentidentified}

\begin{ddtareferentaccepted}[top=3pt,bottom=3pt,left=5pt,right=5pt]
\fontsize{4.95}{5.45}\selectfont
\BAAccepted{ClinicalDescriptionGeneration}; \BAAccepted{ClinicalDescription}; \BAAccepted{HistoricalCaseRetrieval} \BAFirstAccepted{}; \BAAccepted{ClinicalDescriptionEmbeddingGeneration} \BAFirstAccepted{}; \BAAccepted{ClinicalDescriptionEmbedding} \BAFirstAccepted{}; \BAAccepted{HistoricalCaseDescription} \BAFirstAccepted{}; \BAAccepted{HistoricalCaseEmbeddingGeneration} \BAFirstAccepted{}; \BAAccepted{HistoricalCaseEmbedding} \BAFirstAccepted{}; \BAAccepted{HistoricalCaseVectorIndexing} \BAFirstAccepted{}; \BAAccepted{HistoricalCaseVectorIndex} \BAFirstAccepted{}; \BAAccepted{HistoricalCaseSimilarityRetrieval} \BAFirstAccepted{}; \BAAccepted{RetrievedHistoricalCases} \BAFirstAccepted{}; \BAAccepted{ChromaDB} \BAFirstAccepted{}; \BAAccepted{all-MiniLM-L6-v2} \BAFirstAccepted{}; \BAAccepted{MultiSourceTriageSynthesis} \BAFirstAccepted{}.
\end{ddtareferentaccepted}

\begin{ddtapropositionidentified}[top=3pt,bottom=3pt,left=5pt,right=5pt]
\fontsize{3.75}{4.0}\selectfont
...
\textbf{BAP-FR03-03-04}; \textbf{BAP-FR03-03-05}; \textbf{BAP-FR03-03-06}; \textbf{BAP-FR03-03-07}; \textbf{BAP-FR03-03-08}; \textbf{BAP-FR03-03-09}; \textbf{BAP-FR03-03-10}; \textbf{BAP-FR03-03-11}; \textbf{BAP-FR03-03-12}; \textbf{BAP-FR03-03-13}.
\end{ddtapropositionaccepted}
...
ClinicalDescriptionGeneration & \texttt{DEC-MR01-03}; \textbf{\texttt{FR-MR01-03-02}}; \texttt{FR-MR01-03-03} \\
...
ClinicalDescriptionEmbeddingGeneration & \textbf{\texttt{FR-MR01-03-03}} \\
ClinicalDescriptionEmbedding & \textbf{\texttt{FR-MR01-03-03}} \\
HistoricalCaseDescription & \textbf{\texttt{FR-MR01-03-03}} \\
HistoricalCaseEmbeddingGeneration & \textbf{\texttt{FR-MR01-03-03}} \\
HistoricalCaseEmbedding & \textbf{\texttt{FR-MR01-03-03}} \\
HistoricalCaseVectorIndexing & \textbf{\texttt{FR-MR01-03-03}} \\
HistoricalCaseVectorIndex & \textbf{\texttt{FR-MR01-03-03}} \\
HistoricalCaseSimilarityRetrieval & \textbf{\texttt{FR-MR01-03-03}} \\
ChromaDB & \textbf{\texttt{FR-MR01-03-03}} \\
all-MiniLM-L6-v2 & \textbf{\texttt{FR-MR01-03-03}} \\
RetrievedHistoricalCases & \textbf{\texttt{FR-MR01-03-03}}; \texttt{FR-MR01-03-04} \\
MultiSourceTriageSynthesis & \texttt{DEC-MR01-03}; \textbf{\texttt{FR-MR01-03-03}}; \texttt{FR-MR01-03-04} \\
...
\textbf{\texttt{BAP-FR03-03-04}} & \texttt{FR-MR01-03-03} -- \texttt{produce} (current-case embedding) \\
\textbf{\texttt{BAP-FR03-03-05}} & \texttt{FR-MR01-03-03} -- \texttt{realize} (current-case embedding generation) \\
\textbf{\texttt{BAP-FR03-03-06}} & \texttt{FR-MR01-03-03} -- \texttt{produce} (historical-case embedding) \\
\textbf{\texttt{BAP-FR03-03-07}} & \texttt{FR-MR01-03-03} -- \texttt{realize} (historical-case embedding generation) \\
\textbf{\texttt{BAP-FR03-03-08}} & \texttt{FR-MR01-03-03} -- \texttt{produce} (vector index) \\
\textbf{\texttt{BAP-FR03-03-09}} & \texttt{FR-MR01-03-03} -- \texttt{realize} (vector indexing) \\
\textbf{\texttt{BAP-FR03-03-10}} & \texttt{FR-MR01-03-03} -- \texttt{produce} (retrieved cases) \\
\textbf{\texttt{BAP-FR03-03-11}} & \texttt{FR-MR01-03-03} -- \texttt{realize} (similarity retrieval) \\
\textbf{\texttt{BAP-FR03-03-12}} & \texttt{FR-MR01-03-03} -- \texttt{transfer} (Stage 2 $\rightarrow$ Stage 3) \\
\textbf{\texttt{BAP-FR03-03-13}} & \texttt{FR-MR01-03-03} -- \texttt{transfer} (Stage 3 $\rightarrow$ Stage 4) \\
