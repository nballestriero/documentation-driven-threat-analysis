...
\hypersetup{
  pdftitle={DDTA DermaTriage - Parallel Case Study R19 - Transfer / Data Contract Working Page},
...
%<PAGE-HASH-DEFS>
\expandafter\def\csname PageMDfive1\endcsname{2909547baaade7f8dfff2eb961e39d9f}
...
\expandafter\def\csname PageMDfive8\endcsname{5ace08ab23188c06fb3590819a3008e4}
\expandafter\def\csname PageMDfive9\endcsname{b7d01b59ee61789fd467e9789076f7e7}
...
\expandafter\def\csname PageMDfive16\endcsname{016f6228438f19472ff380d75626ac05}
\expandafter\def\csname PageMDfive17\endcsname{6f384da594b81a18e6376196f175d9ca}
\expandafter\def\csname PageMDfive18\endcsname{da12e21beedcd7d49886827f0d1ac7c3}
%</PAGE-HASH-DEFS>
...
{\scriptsize
\textbf{Attivi:} \nolinkurl{DDTA_DOCUMENTATION_AUTHORING_GUIDE_R7_REBUILD_R8.tex}; \nolinkurl{DDTA_BASE_ANALYSIS_GUIDE_REBUILD_R6.tex}; questo \nolinkurl{DDTA_DERMATRIAGE_PARALLEL_CASE_STUDY_R19_TRANSFER_CONTRACT_WORKING_PAGE_R1.tex}. Working plan: \nolinkurl{DDTA_R25_BASE_ANALYSIS_GUIDE_REBUILD_WORK_PLAN_R5.md}.\par
\textbf{Riferimenti BA:} \nolinkurl{DDTA_BASE_ANALYSIS_OPERATIONAL_GUIDE_R3.tex} + BA0--BA5, source register e Core/Complete BA Candidate R1. \textbf{Fase corrente:} usare tale patrimonio BA per completare l'analisi della documentazione DermaTriage riscritta fino alla chiusura di \texttt{MR-01}; solo dopo consolidare nella nuova guida i primi costrutti sufficientemente riesaminati. Le fonti originali non colmano direttamente gap BA: un gap di significato torna prima alla documentazione.\par
...
\begin{ddtareferentidentified}
\scriptsize
\BACandidate{Qwen2-VL-7B-Instruct} \BANew{}; \BACandidate{ClinicalDescription} \BANew{}.\par
\end{ddtareferentidentified}

\begin{ddtareferentaccepted}
\scriptsize
\BAAccepted{DermaTriage}; \BAAccepted{LesionImage}; \BAAccepted{ClinicalDescriptionGeneration} \BAFirstAccepted{}; \BAAccepted{Qwen2-VL-7B-Instruct} \BAFirstAccepted{}; \BAAccepted{ClinicalDescription} \BAFirstAccepted{}.\par
\end{ddtareferentaccepted}
...
\begin{ddtapropositionaccepted}
\tiny
\textbf{BAP-FR03-02-01}; \textbf{BAP-FR03-02-02}.
\end{ddtapropositionaccepted}
...
\begin{ddtareferentidentified}
\scriptsize
\BACandidate{ChromaDB} \BANew{}; \BACandidate{all-MiniLM-L6-v2} \BANew{}; \BACandidate{RetrievedHistoricalCaseContext} \BANew{}.\par
\end{ddtareferentidentified}

\begin{ddtareferentaccepted}
\scriptsize
\BAAccepted{DermaTriage}; \BAAccepted{DermatologicalCase}; \BAAccepted{ClinicalDescription}; \BAAccepted{HistoricalCaseRetrieval} \BAFirstAccepted{}; \BAAccepted{ChromaDB} \BAFirstAccepted{}; \BAAccepted{all-MiniLM-L6-v2} \BAFirstAccepted{}; \BAAccepted{RetrievedHistoricalCaseContext} \BAFirstAccepted{}.\par
\end{ddtareferentaccepted}
...
\begin{ddtapropositionaccepted}
\tiny
\textbf{BAP-FR03-03-01}; \textbf{BAP-FR03-03-02}.
\end{ddtapropositionaccepted}
...
\texttt{T06} & \texttt{ClinicalDescriptionGeneration -> HistoricalCaseRetrieval : ClinicalDescription} & Clinical-description contract: testo strutturato in cinque parti/bullet; parti esatte, ordine, lingua, serialization, mandatory/optional e incomplete behavior da verificare. \\
...
\texttt{T08} & \texttt{ClinicalDescriptionGeneration -> MultiSourceTriageSynthesis : ClinicalDescription} & Verificare se Stage4 consuma lo stesso contract T06 o una rappresentazione distinta; correlation al caso e realization del passaggio ?. \\
