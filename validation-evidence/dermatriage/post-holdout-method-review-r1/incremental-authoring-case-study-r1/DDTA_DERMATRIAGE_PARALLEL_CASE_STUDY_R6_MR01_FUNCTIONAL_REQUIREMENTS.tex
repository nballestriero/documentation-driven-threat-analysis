...
\hypersetup{
  pdftitle={DDTA DermaTriage - Parallel Case Study R6 - MR-01 FunctionalRequirements},
...
%<PAGE-HASH-DEFS>
\expandafter\def\csname PageMDfive1\endcsname{3c557ea0ac4559bca76554d8baef4056}
...
\expandafter\def\csname PageMDfive4\endcsname{322fc7183facdfd6dc0b1a176048ca3c}
\expandafter\def\csname PageMDfive5\endcsname{8fff9e762cfea77328cfc9c0667922ac}
\expandafter\def\csname PageMDfive6\endcsname{af068bcc05ea1d059fd699cf3ecefca8}
\expandafter\def\csname PageMDfive7\endcsname{899bd25addbd3fd941a546ecda7a7015}
\expandafter\def\csname PageMDfive8\endcsname{ec095abaa9d3bcb448a77abb2e7f2b90}
\expandafter\def\csname PageMDfive9\endcsname{79e89af41d997b57102fa8ef406cd738}
\expandafter\def\csname PageMDfive10\endcsname{d39b21f3ca35011e5eb548ee8ae962ca}
\expandafter\def\csname PageMDfive11\endcsname{05eec8ddc883d12b3b18409a95da7d42}
\expandafter\def\csname PageMDfive12\endcsname{1ad1a4986dc1e8525c40b52ab2e73a72}
\expandafter\def\csname PageMDfive13\endcsname{6a8766cfd935d80023ec6afa818c94c5}
\expandafter\def\csname PageMDfive14\endcsname{6caf75ae6def5f1137daf4c40d52cffb}
\expandafter\def\csname PageMDfive15\endcsname{abf9008d770509039fc7ffbd1cf1f655}
\expandafter\def\csname PageMDfive16\endcsname{589ab9dd2fc47da8ed0c64692eb2a76d}
\expandafter\def\csname PageMDfive17\endcsname{58aca712eadb3222507468f39fae50fe}
\expandafter\def\csname PageMDfive18\endcsname{9839ce3d8b2acdf063a49341888b68d7}
%</PAGE-HASH-DEFS>
...
\vspace{2mm}
{\color{white!88}\small La documentazione di progetto occupa circa due terzi della pagina; la Base Analysis occupa il terzo laterale e resta non iniziata in questo passaggio. La documentazione e' ordinata gerarchicamente: MacroRequirement, quindi le sue Decision e, immediatamente sotto ogni Decision, i relativi FunctionalRequirement.}
\end{tcolorbox}
...
\begin{ddtaworking}[title={Base Analysis}]
\small
La Base Analysis di questo FunctionalRequirement non e' ancora stata eseguita. La colonna resta intenzionalmente non popolata. La futura BA dovra' derivare il proprio modello dal significato qui descritto senza modificarlo o completarlo per inferenza.
\end{ddtaworking}
...
\begin{ddtaworking}[title={Base Analysis}]
\small
La Base Analysis di questo FunctionalRequirement non e' ancora stata eseguita. In particolare, il futuro passaggio BA non dovra' colmare la lacuna symptom-only verso P1--P4 e non dovra' trasformare gli SLA documentati in vincoli canonici senza una precedente chiusura della documentazione.
\end{ddtaworking}
