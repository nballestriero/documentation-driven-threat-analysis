...
\expandafter\def\csname PageMDfive32\endcsname{9faf8d41344390a05878e91d5d4ac7bd}
\expandafter\def\csname PageMDfive33\endcsname{a88683a25d7bb43dc90fe07ed38a1ebd}
\expandafter\def\csname PageMDfive34\endcsname{0172ab39eab0f5138922026bc4d1125e}
\expandafter\def\csname PageMDfive35\endcsname{58e8c3acb5d1779941538a64c6bb1dd2}
\expandafter\def\csname PageMDfive36\endcsname{093d281c3a6ffd40a859982775608285}
%</PAGE-HASH-DEFS>
...
%</PAGE-CONTENT:31>
\clearpage
% Preserve standalone FR-08 heading counter while DEC-04/DEC-05 branches are inserted ahead of it.
\setcounter{subsection}{0}
\setcounter{subsubsection}{0}
%<PAGE-DESC:32>MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta
%<PAGE-CONTENT:32>
...
%</PAGE-CONTENT:32>
\clearpage
%<PAGE-DESC:33>Registro Base Analysis - BAReferent e BAProposition
%<PAGE-CONTENT:33>
...
\midrule
DermaTriage & \texttt{MR-01}; \textbf{\texttt{DEC-MR01-01}}; \texttt{FR-MR01-01-01}; \texttt{DEC-MR01-03}; \texttt{FR-MR01-03-01}; \texttt{FR-MR01-03-02}; \texttt{FR-MR01-03-04}; \texttt{DEC-MR01-04}; \texttt{FR-MR01-04-01}; \texttt{MR-02}; \texttt{MR-03}; \texttt{DEC-03}; \texttt{FR-03}; \texttt{FR-12}; \texttt{DEC-15}; \texttt{FR-23}; \texttt{DEC-16}; \texttt{FR-24}; \texttt{FR-25}; \texttt{MR-04}; \texttt{DEC-04}; \texttt{FR-04}; \texttt{FR-05}; \texttt{DEC-05} \\
...
PromptEvolutionPath & \textbf{\texttt{MR-04}}; \texttt{DEC-04}; \texttt{FR-04}; \texttt{DEC-05}; \texttt{FR-13}; \texttt{FR-14}; \texttt{FR-15} \\
...
%</PAGE-CONTENT:33>
\clearpage
%<PAGE-DESC:34>Registro Base Analysis - BAProposition
%<PAGE-CONTENT:34>
...
%</PAGE-CONTENT:34>
\clearpage
%<PAGE-DESC:35>MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]
%<PAGE-CONTENT:35>
...
%</PAGE-CONTENT:35>
\clearpage
%<PAGE-DESC:36>Indice di integrita delle pagine
%<PAGE-CONTENT:36>
...
\IntegrityRow{32}{MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta}{\PageMDfive{32}}
\IntegrityRow{33}{Registro Base Analysis - BAReferent e BAProposition}{\PageMDfive{33}}
\IntegrityRow{34}{Registro Base Analysis - BAProposition}{\PageMDfive{34}}
\IntegrityRow{35}{MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]}{\PageMDfive{35}}
\IntegrityRow{36}{Indice di integrita delle pagine}{\PageMDfive{36}}
%</PAGE-INTEGRITY-ROWS>
\bottomrule
\end{tabularx}
\endgroup
