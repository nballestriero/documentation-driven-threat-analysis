...
\expandafter\def\csname PageMDfive3\endcsname{e0a2e06de7d5b7d2c17be5b4c2174123}
\expandafter\def\csname PageMDfive4\endcsname{a85d18b44bd6e3d6cb99220e093e049c}
...
\expandafter\def\csname PageMDfive10\endcsname{4b655ebd15791ba935d4d7e668f22471}
\expandafter\def\csname PageMDfive11\endcsname{a9569e8086367d55854bccd3cf09f99f}
\expandafter\def\csname PageMDfive12\endcsname{de49645acb22e76bb345d691937b0109}
\expandafter\def\csname PageMDfive13\endcsname{d718ab9cf72c7cd323e0e0997dde32e3}
...
\expandafter\def\csname PageMDfive17\endcsname{9a6a624d9075825e45b95bf7ad1c1a2e}
\expandafter\def\csname PageMDfive18\endcsname{751d0c7dc001b0757852d3a68215cd92}
\expandafter\def\csname PageMDfive19\endcsname{cc98a497ca37d98976f57b785863c4ac}
%</PAGE-HASH-DEFS>
...
\textbf{\texttt{BAP-FR03-03-04}} & \texttt{FR-MR01-03-03B} -- \texttt{produce} (current-case embedding) \\
...
\textbf{\texttt{BAP-FR03-03-10}} & \texttt{FR-MR01-03-03B} -- \texttt{produce} (retrieved cases) \\
\textbf{\texttt{BAP-FR03-03-11}} & \texttt{FR-MR01-03-03B} -- \texttt{realize} (similarity retrieval) \\
\textbf{\texttt{BAP-FR03-03-12}} & \texttt{FR-MR01-03-03B} -- \texttt{transfer} (Stage 2 $\rightarrow$ Stage 3) \\
\textbf{\texttt{BAP-FR03-03-13}} & \texttt{FR-MR01-03-03B} -- \texttt{transfer} (Stage 3 $\rightarrow$ Stage 4) \\
