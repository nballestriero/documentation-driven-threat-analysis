...
\expandafter\def\csname PageMDfive41\endcsname{9faf8d41344390a05878e91d5d4ac7bd}
\expandafter\def\csname PageMDfive42\endcsname{cc9d793c0d71a27123664f6236894985}
\expandafter\def\csname PageMDfive43\endcsname{02f2e0d6851da52d8f4f83e10943184e}
\expandafter\def\csname PageMDfive44\endcsname{df70ba8f961369f44bdd2b8e064a53bd}
\expandafter\def\csname PageMDfive45\endcsname{1d43ee6df65cabfd2f1d59e7d3351a91}
%</PAGE-HASH-DEFS>
...
%<PAGE-DESC:41>MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta
%<PAGE-CONTENT:41>
...
%</PAGE-CONTENT:41>
\clearpage
%<PAGE-DESC:42>Registro Base Analysis - BAReferent e BAProposition
%<PAGE-CONTENT:42>
...
ClassifierAdaptationPath & \textbf{\texttt{MR-04}}; \texttt{DEC-04}; \texttt{FR-05}; \texttt{DEC-05}; \texttt{FR-13}; \texttt{FR-14}; \texttt{FR-15}; \texttt{DEC-10}; \texttt{FR-07} \\
...
B4 & \textbf{\texttt{DEC-15}}; \texttt{FR-23}; \texttt{DEC-16}; \texttt{FR-25}; \texttt{FR-07} \\
B4TriageOutcome & \texttt{DEC-15}; \textbf{\texttt{FR-23}} \\
ClinicianValidation & \texttt{DEC-15}; \textbf{\texttt{FR-23}} \\
ValidatedOutcome & \texttt{DEC-15}; \textbf{\texttt{FR-23}}; \texttt{FR-07} \\
...
%</PAGE-CONTENT:42>
\clearpage
%<PAGE-DESC:43>Registro Base Analysis - BAProposition
%<PAGE-CONTENT:43>
...
\textbf{\texttt{BAP-FR23-03}} & \texttt{FR-23}; \texttt{FR-07} -- \texttt{transfer} (\texttt{B4 -> DermaTriage : ValidatedOutcome}); \texttt{FR-07} riusa la conveyance upstream gia' accettata e non crea una proposition duplicata \\
...
%</PAGE-CONTENT:43>
\clearpage
%<PAGE-DESC:44>MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]
%<PAGE-CONTENT:44>
...
%</PAGE-CONTENT:44>
\clearpage
%<PAGE-DESC:45>Indice di integrita delle pagine
%<PAGE-CONTENT:45>
...
\IntegrityRow{41}{MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta}{\PageMDfive{41}}
\IntegrityRow{42}{Registro Base Analysis - BAReferent e BAProposition}{\PageMDfive{42}}
\IntegrityRow{43}{Registro Base Analysis - BAProposition}{\PageMDfive{43}}
\IntegrityRow{44}{MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]}{\PageMDfive{44}}
\IntegrityRow{45}{Indice di integrita delle pagine}{\PageMDfive{45}}
%</PAGE-INTEGRITY-ROWS>
\bottomrule
\end{tabularx}
\endgroup
