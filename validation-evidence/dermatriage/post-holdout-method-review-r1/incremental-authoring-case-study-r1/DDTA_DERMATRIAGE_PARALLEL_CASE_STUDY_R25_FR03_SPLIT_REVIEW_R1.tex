...
\expandafter\def\csname PageMDfive35\endcsname{9faf8d41344390a05878e91d5d4ac7bd}
\expandafter\def\csname PageMDfive36\endcsname{d654543da005e69b10ce72d992f94cb7}
\expandafter\def\csname PageMDfive37\endcsname{0172ab39eab0f5138922026bc4d1125e}
\expandafter\def\csname PageMDfive38\endcsname{58e8c3acb5d1779941538a64c6bb1dd2}
\expandafter\def\csname PageMDfive39\endcsname{a84025b9357944a6f11425d2f61bf348}
%</PAGE-HASH-DEFS>
...
%<PAGE-DESC:35>MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta
%<PAGE-CONTENT:35>
...
%</PAGE-CONTENT:35>
\clearpage
%<PAGE-DESC:36>Registro Base Analysis - BAReferent e BAProposition
%<PAGE-CONTENT:36>
...
\midrule
DermaTriage & \texttt{MR-01}; \textbf{\texttt{DEC-MR01-01}}; \texttt{FR-MR01-01-01}; \texttt{DEC-MR01-03}; \texttt{FR-MR01-03-01}; \texttt{FR-MR01-03-02}; \texttt{FR-MR01-03-04}; \texttt{DEC-MR01-04}; \texttt{FR-MR01-04-01}; \texttt{MR-02}; \texttt{MR-03}; \texttt{DEC-03}; \texttt{FR-03}; \texttt{FR-12}; \texttt{DEC-15}; \texttt{FR-23}; \texttt{DEC-16}; \texttt{FR-24}; \texttt{FR-25}; \texttt{MR-04}; \texttt{DEC-04}; \texttt{FR-04}; \texttt{FR-05}; \texttt{DEC-05} ; \texttt{FR-09} \\
...
EfficientNet-B4 & \textbf{\texttt{FR-MR01-03-01}}; \texttt{MR-04}; \texttt{FR-05}; \texttt{DEC-06} \\
...
%</PAGE-CONTENT:36>
\clearpage
%<PAGE-DESC:37>Registro Base Analysis - BAProposition
%<PAGE-CONTENT:37>
...
%</PAGE-CONTENT:37>
\clearpage
%<PAGE-DESC:38>MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]
%<PAGE-CONTENT:38>
...
\IntegrityRow{35}{MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta}{\PageMDfive{35}}
\IntegrityRow{36}{Registro Base Analysis - BAReferent e BAProposition}{\PageMDfive{36}}
\IntegrityRow{37}{Registro Base Analysis - BAProposition}{\PageMDfive{37}}
\IntegrityRow{38}{MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]}{\PageMDfive{38}}
