...
\expandafter\def\csname PageMDfive15\endcsname{59401f96bd5ae4f938ea0b7d02d05878}
\expandafter\def\csname PageMDfive16\endcsname{b79abb8c1930e6e407ffcd6795722076}
\expandafter\def\csname PageMDfive17\endcsname{820c1ed8c9bc6eae0fd15014cbf1f3df}
\expandafter\def\csname PageMDfive18\endcsname{60b077964dc202b0e8ae17b0e9cce7d0}
\expandafter\def\csname PageMDfive19\endcsname{e5085117316308ad10f9d8324bedf7eb}
\expandafter\def\csname PageMDfive20\endcsname{9faf8d41344390a05878e91d5d4ac7bd}
\expandafter\def\csname PageMDfive21\endcsname{c2b83bbcc4a916a75496c1472a277199}
\expandafter\def\csname PageMDfive22\endcsname{ce0a25c6740299f349c3d90a24dce940}
\expandafter\def\csname PageMDfive23\endcsname{58e8c3acb5d1779941538a64c6bb1dd2}
\expandafter\def\csname PageMDfive24\endcsname{a3756c5036f323dcbec0eee402bee478}
%</PAGE-HASH-DEFS>
...
\texttt{ClinicalReviewResult <correlation / association> OriginalDermaTriageOutcome}\par
\texttt{OriginalDermaTriageOutcome <distinguishable from> ClinicalReviewResult}\par
Nessun nuovo operatore viene introdotto in questo checkpoint.
\end{ddtaopenrelations}
...
\texttt{ClinicalReviewResult <associatedWith> OriginalDermaTriageOutcome}\par
\medskip
...
\textbf{Correlation pressure.} Il binding tra la singola review e lo specifico esito originario resta autonomo e non viene forzato in \texttt{constrain}.
\end{ddtaopenrelations}
...
%</PAGE-CONTENT:18>
\clearpage
%<PAGE-DESC:19>MR-04 - Adattamento controllato sulla base della revisione clinica
%<PAGE-CONTENT:19>
...
%</PAGE-CONTENT:19>
\clearpage
%<PAGE-DESC:20>MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta
%<PAGE-CONTENT:20>
...
%</PAGE-CONTENT:20>
\clearpage
%<PAGE-DESC:21>Registro Base Analysis - BAReferent e BAProposition
%<PAGE-CONTENT:21>
...
\midrule
DermaTriage & \texttt{MR-01}; \textbf{\texttt{DEC-MR01-01}}; \texttt{FR-MR01-01-01}; \texttt{DEC-MR01-03}; \texttt{FR-MR01-03-01}; \texttt{FR-MR01-03-02}; \texttt{FR-MR01-03-04}; \texttt{DEC-MR01-04}; \texttt{FR-MR01-04-01}; \texttt{MR-02}; \texttt{MR-03}; \texttt{DEC-03}; \texttt{FR-03}; \texttt{FR-12} \\
...
ClinicalReviewResult & \textbf{\texttt{MR-03}}; \texttt{DEC-03}; \texttt{FR-03}; \texttt{FR-12} \\
OriginalDermaTriageOutcome & \textbf{\texttt{MR-03}}; \texttt{DEC-03}; \texttt{FR-03}; \texttt{FR-12} \\
...
%</PAGE-CONTENT:21>
\clearpage
%<PAGE-DESC:22>Registro Base Analysis - BAProposition
%<PAGE-CONTENT:22>
...
%</PAGE-CONTENT:22>
\clearpage
%<PAGE-DESC:23>MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]
%<PAGE-CONTENT:23>
...
%</PAGE-CONTENT:23>
\clearpage
%<PAGE-DESC:24>Indice di integrita delle pagine
%<PAGE-CONTENT:24>
...
\IntegrityRow{19}{MR-04 - Adattamento controllato sulla base della revisione clinica}{\PageMDfive{19}}
\IntegrityRow{20}{MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta}{\PageMDfive{20}}
\IntegrityRow{21}{Registro Base Analysis - BAReferent e BAProposition}{\PageMDfive{21}}
\IntegrityRow{22}{Registro Base Analysis - BAProposition}{\PageMDfive{22}}
\IntegrityRow{23}{MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]}{\PageMDfive{23}}
\IntegrityRow{24}{Indice di integrita delle pagine}{\PageMDfive{24}}
%</PAGE-INTEGRITY-ROWS>
\bottomrule
\end{tabularx}
