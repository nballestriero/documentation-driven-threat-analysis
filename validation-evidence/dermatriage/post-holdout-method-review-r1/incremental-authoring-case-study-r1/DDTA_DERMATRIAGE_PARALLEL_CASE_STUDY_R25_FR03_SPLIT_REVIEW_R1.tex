...
\expandafter\def\csname PageMDfive21\endcsname{e5085117316308ad10f9d8324bedf7eb}
\expandafter\def\csname PageMDfive22\endcsname{9faf8d41344390a05878e91d5d4ac7bd}
\expandafter\def\csname PageMDfive23\endcsname{b5a45b6d0e21574c1c0c98c59fb6d199}
\expandafter\def\csname PageMDfive24\endcsname{5f1feb73878fb67ef3a9be07d881b9b9}
\expandafter\def\csname PageMDfive25\endcsname{58e8c3acb5d1779941538a64c6bb1dd2}
\expandafter\def\csname PageMDfive26\endcsname{4fe43655b5eed4c8e7ff6f4ee542c778}
%</PAGE-HASH-DEFS>
...
%</PAGE-CONTENT:20>
\clearpage
%<PAGE-DESC:21>MR-04 - Adattamento controllato sulla base della revisione clinica
%<PAGE-CONTENT:21>
...
%</PAGE-CONTENT:21>
\clearpage
%<PAGE-DESC:22>MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta
%<PAGE-CONTENT:22>
...
%</PAGE-CONTENT:22>
\clearpage
%<PAGE-DESC:23>Registro Base Analysis - BAReferent e BAProposition
%<PAGE-CONTENT:23>
...
\midrule
DermaTriage & \texttt{MR-01}; \textbf{\texttt{DEC-MR01-01}}; \texttt{FR-MR01-01-01}; \texttt{DEC-MR01-03}; \texttt{FR-MR01-03-01}; \texttt{FR-MR01-03-02}; \texttt{FR-MR01-03-04}; \texttt{DEC-MR01-04}; \texttt{FR-MR01-04-01}; \texttt{MR-02}; \texttt{MR-03}; \texttt{DEC-03}; \texttt{FR-03}; \texttt{FR-12}; \texttt{DEC-15}; \texttt{FR-23} \\
...
B4 & \textbf{\texttt{DEC-15}}; \texttt{FR-23} \\
...
%</PAGE-CONTENT:23>
\clearpage
%<PAGE-DESC:24>Registro Base Analysis - BAProposition
%<PAGE-CONTENT:24>
...
%</PAGE-CONTENT:24>
\clearpage
%<PAGE-DESC:25>MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]
%<PAGE-CONTENT:25>
...
\IntegrityRow{21}{MR-04 - Adattamento controllato sulla base della revisione clinica}{\PageMDfive{21}}
\IntegrityRow{22}{MR-04 > DEC-11 > FR-08 - Derivazione del target di supervisione dalla priorita P-scale corretta}{\PageMDfive{22}}
\IntegrityRow{23}{Registro Base Analysis - BAReferent e BAProposition}{\PageMDfive{23}}
\IntegrityRow{24}{Registro Base Analysis - BAProposition}{\PageMDfive{24}}
\IntegrityRow{25}{MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]}{\PageMDfive{25}}
