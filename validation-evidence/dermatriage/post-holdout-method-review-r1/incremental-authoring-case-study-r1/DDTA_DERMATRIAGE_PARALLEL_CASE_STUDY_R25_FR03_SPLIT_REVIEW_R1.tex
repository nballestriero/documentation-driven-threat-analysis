...
\expandafter\def\csname PageMDfive13\endcsname{c28d66ecaa2a53bd01a828ee48700a43}
\expandafter\def\csname PageMDfive14\endcsname{22b589e352a735848af68026ba7ccd6e}
\expandafter\def\csname PageMDfive15\endcsname{88277fb1892436757c84526e8a5be8b0}
\expandafter\def\csname PageMDfive16\endcsname{e5085117316308ad10f9d8324bedf7eb}
\expandafter\def\csname PageMDfive17\endcsname{f05f30834c8389f3222dcb3b27dd8072}
\expandafter\def\csname PageMDfive18\endcsname{58e8c3acb5d1779941538a64c6bb1dd2}
\expandafter\def\csname PageMDfive19\endcsname{f9d720f74506eb995b0ba0cf09809a35}
%</PAGE-HASH-DEFS>
...
\emph{Candidate \texttt{operatorStructure} su \texttt{BAP-FR04-01-01} (rilocazione R7 ancora sotto review):}\par
\texttt{operatorStructure}\par
\hspace*{1em}\texttt{decisionRule}\par
\hspace*{2em}\texttt{HIGH + confidence > 0.85 -> P1}\par
\hspace*{2em}\texttt{HIGH, other applicable cases -> P2}\par
\hspace*{2em}\texttt{MEDIUM -> P3}\par
\hspace*{2em}\texttt{LOW -> P4}\par
\emph{Pressure aperta: la comparison \texttt{> 0.85} richiede il candidate key \texttt{greaterThan}; nessun ELSE globale viene inferito.}
\end{ddtapropositionidentified}
...
\texttt{polarity = affirmative}\par
\smallskip
\textbf{Accettate: BAP-FR04-01-01; BAP-FR04-01-02.} La \texttt{decisionRule} annidata resta candidate e non e' inclusa nell'accettazione.
\end{ddtapropositionaccepted}
...
%</PAGE-CONTENT:14>
\clearpage
%<PAGE-DESC:15>MR-03 - Validazione e correzione medica degli esiti
%<PAGE-CONTENT:15>
...
%</PAGE-CONTENT:15>
\clearpage
%<PAGE-DESC:16>MR-04 - Adattamento controllato sulla base della revisione clinica
%<PAGE-CONTENT:16>
...
%</PAGE-CONTENT:16>
\clearpage
%<PAGE-DESC:17>Registro Base Analysis - BAReferent e BAProposition
%<PAGE-CONTENT:17>
...
\midrule
DermaTriage & \texttt{MR-01}; \textbf{\texttt{DEC-MR01-01}}; \texttt{FR-MR01-01-01}; \texttt{DEC-MR01-03}; \texttt{FR-MR01-03-01}; \texttt{FR-MR01-03-02}; \texttt{FR-MR01-03-04}; \texttt{DEC-MR01-04}; \texttt{FR-MR01-04-01} \\
...
\textbf{\texttt{BAP-FR04-01-01}} & \texttt{FR-MR01-04-01} -- \texttt{produce}, \texttt{condition: LesionImage available}; candidate \texttt{operatorStructure.decisionRule} non inclusa nell'accettazione \\
\textbf{\texttt{BAP-FR04-01-02}} & \texttt{FR-MR01-04-01} -- \texttt{realize} (\texttt{OperationalPriorityDerivation -> AdaptationLayer}) \\
\bottomrule
\end{tabularx}
%</PAGE-CONTENT:17>
\clearpage
%<PAGE-DESC:18>MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]
%<PAGE-CONTENT:18>
...
\IntegrityRow{15}{MR-03 - Validazione e correzione medica degli esiti}{\PageMDfive{15}}
\IntegrityRow{16}{MR-04 - Adattamento controllato sulla base della revisione clinica}{\PageMDfive{16}}
\IntegrityRow{17}{Registro Base Analysis - BAReferent e BAProposition}{\PageMDfive{17}}
\IntegrityRow{18}{MR-01 - Inventario temporaneo transfer, contract e decisioni BA [DA CANCELLARE]}{\PageMDfive{18}}
